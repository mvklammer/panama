...
public interface Validator {
	...
	public final static String IP_VALIDATION_FAILED = Dispatcher.PREFIX+"_validator_ip_failed";
	public final static String SAFETEXT_VALIDATION_FAILED = Dispatcher.PREFIX+"_validator_safetext_failed";
	public final static String SIMPLEPASSWORD_VALIDATION_FAILED = Dispatcher.PREFIX+"_validator_simplepassword_failed";
	public final static String COMPLEXPASSWORD_VALIDATION_FAILED = Dispatcher.PREFIX+"_validator_complexpassword_failed";
	public final static String SAFENAME_VALIDATION_FAILED = Dispatcher.PREFIX+"_validator_complexpassword_failed";
